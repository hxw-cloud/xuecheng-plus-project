...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\Computers\\Desktop\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "D:\\Computers\\Desktop\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\Computers\\Desktop\\ffmpeg\\1.avi";
        //转换后mp4文件的名称
        String mp4_name = "01.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\Computers\\Desktop\\ffmpeg\\01.mp4";
        //创建工具类对象
